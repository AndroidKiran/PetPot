...
class PetPhotoViewerAdapter(private val petPhotoViewerListener: PetPhotoViewerListener): ListAdapter<PhotosItemEntity, BaseViewHolder>(UrlDiff) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder =
        PetPhotoViewHolder(ItemPetPhotoBinding.inflate(LayoutInflater.from(parent.context),
            parent, false))
    ...
    object UrlDiff : DiffUtil.ItemCallback<PhotosItemEntity>() {
        override fun areItemsTheSame(oldItemEntity: PhotosItemEntity, newItemEntity: PhotosItemEntity) =
            oldItemEntity == newItemEntity

        override fun areContentsTheSame(oldItemEntity: PhotosItemEntity, newItemEntity: PhotosItemEntity) =
            oldItemEntity == newItemEntity
    }

    inner class PetPhotoViewHolder(private val binding: ItemPetPhotoBinding): BaseViewHolder(binding.root) {
