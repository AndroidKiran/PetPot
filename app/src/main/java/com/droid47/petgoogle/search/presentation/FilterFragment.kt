...
import com.droid47.petgoogle.search.presentation.viewmodel.FilterViewModel.Companion.EVENT_APPLY_SORT_FILTER
...
import com.droid47.petgoogle.search.presentation.widgets.SortPopupMenu
...
class FilterFragment :
    ...
    private fun updateErrorState(throwable: Throwable) {
        ...
        errorState.apply {
            ...
            this.errorBtnText = getString(R.string.clear)
