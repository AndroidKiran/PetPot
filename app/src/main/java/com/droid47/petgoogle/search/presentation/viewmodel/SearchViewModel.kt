...
import com.droid47.petgoogle.search.domain.interactors.FetchAppliedFilterUseCase
import com.droid47.petgoogle.search.domain.interactors.SearchPetUseCase
import com.droid47.petgoogle.search.domain.interactors.UpdateFilterUseCase
...
class SearchViewModel @Inject constructor(
    ...
    private fun attachSearchEvent() {
        searchSubject.debounce(30, TimeUnit.MILLISECONDS)
