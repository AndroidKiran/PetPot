package com.droid47.petfriend.organization.presentation.ui.adapter
...
import com.droid47.petfriend.base.extensions.openDialer
import com.droid47.petfriend.base.extensions.openUrlInBrowser
import com.droid47.petfriend.base.extensions.sendEmail
import com.droid47.petfriend.base.widgets.BaseCheckableEntity
import com.droid47.petfriend.base.widgets.BaseViewHolder
import com.droid47.petfriend.databinding.ItemOrganisationBinding
import com.droid47.petfriend.organization.data.models.OrganizationCheckableEntity

class PagedListOrganizationAdapter(private val onItemClick: (BaseCheckableEntity) -> Unit) :
