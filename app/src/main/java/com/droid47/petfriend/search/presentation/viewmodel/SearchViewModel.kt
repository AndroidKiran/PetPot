...
class SearchViewModel @Inject constructor(
    ...
    val itemPaginationStateLiveData: LiveData<ItemPaginationState> = petPaginationUseCase.itemPaginationStateLiveData
            ...
            .flatMapCompletable { filters ->
                if (!(filters.location ?: "").equals(location, true)) {
                    updateFilterUseCase.buildUseCaseCompletable(
                        PetFilterCheckableEntity(location, LOCATION, selected = true, filterApplied = true)
