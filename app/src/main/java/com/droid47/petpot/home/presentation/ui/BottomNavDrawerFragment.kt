...
import com.droid47.petpot.databinding.FragmentBottomNavDrawerBinding
import com.droid47.petpot.home.presentation.components.*
...
class BottomNavDrawerFragment :
    ...
    override fun getClassName(): String = BottomNavDrawerFragment::class.java.simpleName

    override fun getScreenName(): String = AnalyticsScreens.NAVIGATION_SCREEN
    ...
    private fun toggleSandwich() {
        ...
        sandwichAnim = ValueAnimator.ofFloat(initialProgress, newProgress).apply {
            ...
            duration = (abs(newProgress - initialProgress) *
                    resources.getInteger(R.integer.pet_motion_duration_small)).toLong()
        }
        sandwichAnim?.start()
    }
