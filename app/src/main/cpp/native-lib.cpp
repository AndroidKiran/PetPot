...
JNIEXPORT
jstring
Java_com_droid47_petpot_app_AppKeyMaker_getClientId(JNIEnv *env, jobject object) {
...
JNIEXPORT
jstring
Java_com_droid47_petpot_app_AppKeyMaker_getClientSecret(JNIEnv *env, jobject object) {
